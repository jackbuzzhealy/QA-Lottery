...
def generateLotteryNumbers():
    ...
    winningLotteryNumbers = requests.post('http://app4:5003/postMyLotteryNumbers', data=myLotteryNumbers.text)
...
def generateLighteningBall():
    ...
    winningLighteningBall = requests.post('http://app4:5003/postMyLighteningBall', data=myLighteningBall.text)
